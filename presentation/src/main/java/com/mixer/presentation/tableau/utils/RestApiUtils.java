package com.mixer.presentation.tableau.utils;
...
import com.mixer.presentation.tableau.vo.CapabilityType;
import com.mixer.presentation.tableau.vo.FileUploadType;
import com.mixer.presentation.tableau.vo.GranteeCapabilitiesType;
import com.mixer.presentation.tableau.vo.GroupType;
import com.mixer.presentation.tableau.vo.ObjectFactory;
import com.mixer.presentation.tableau.vo.PermissionsType;
import com.mixer.presentation.tableau.vo.ProjectListType;
import com.mixer.presentation.tableau.vo.ProjectType;
import com.mixer.presentation.tableau.vo.SiteListType;
import com.mixer.presentation.tableau.vo.SiteType;
import com.mixer.presentation.tableau.vo.TableauCredentialsType;
import com.mixer.presentation.tableau.vo.TsRequest;
import com.mixer.presentation.tableau.vo.TsResponse;
import com.mixer.presentation.tableau.vo.WorkbookListType;
import com.mixer.presentation.tableau.vo.WorkbookType;
...
public class RestApiUtils {
    ...
    private Marshaller s_jaxbMarshaller;
    private Unmarshaller s_jaxbUnmarshaller;
...
//    }
    ...
    private void initialize() {
        try {
            m_properties.load(new FileInputStream("C:\\amolp\\Study\\config.properties"));
            JAXBContext jaxbContext = JAXBContext.newInstance(TsRequest.class, TsResponse.class);
            SchemaFactory schemaFactory = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
            Schema schema = schemaFactory.newSchema(new File("C:\\amolp\\Study\\ts-api_2_3.xsd"));
            ...
            throw new IllegalStateException("Failed to initialize the REST API" + ex.getStackTrace());
        }
    }
