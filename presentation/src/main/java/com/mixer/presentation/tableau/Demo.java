package com.mixer.presentation.tableau;
...
import com.mixer.presentation.tableau.utils.RestApiUtils;
...
//    }
    ...
    public Demo() {
    	...
    	s_properties = new Properties();
    	 ...
    	 try {
             s_properties.load(new FileInputStream("C:\\amolp\\Study\\config.properties"));
         } catch (IOException e) {
             s_logger.error("Failed to load configuration files.");
         }
    ...
    public String getToken() {
    	...
    	s_restApiUtils= new RestApiUtils();
        ...
        String username = "amolbpathak@gmail.com";
        String password ="Zaq1@wsx";
        String contentUrl = "patest";
  ...
  /*      ProjectType defaultProject = null;
        ...
        for (ProjectType project : projects.getProject()) {
            if (project.getName().equalsIgnoreCase("default")) {
